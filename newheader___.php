...
<header id="main-header" class="main-header main-header--startpage">
...
<h1  style="float: left; z-index: 2147483647;position:relative;width: 140px;" class="logo_header desktop-2 pull-left <?php echo the_title(); ?>">
...
<a href="<?php echo get_site_url(); ?>/order-accessories" class="post_title_link <?php if(get_the_ID()=="399"){ echo "active";} ?>">Order Accessories </a>
</li>
...
?>
<li class="head_top_nav"><a href="<?php echo get_the_permalink($posts_array_val->ID) ?>"  class="post_title_link <?php if($id==$posts_array_val->ID){ echo "active"; } ?>"><?php echo $posts_array_val->post_title; ?></a></li>
<?php } 
...
<a href="<?php echo get_the_permalink($posts_array_val->ID) ?>">
<h4 class="main-header__about__links__link__header verlag verlag--bold"><?php echo $posts_array_val->post_title; ?></h4>
<h5><?php echo $posts_array_val->post_excerpt; ?></h5>
</a>
</article>
<?php } ?>
</div>
...
<a href="<?php echo get_site_url(); ?>/about-raskin/" style="background-image: none; background: black;">
...
<a data-controller="toggle,lock-body" data-toggle-selector=".main-header__mobile-menu" data-toggle-class="main-header__mobile-menu--open" class="main-header__panel__mobile"><span class="icon-menu"></span></a>
...
<a href="../start/request-samples.html" o-controller="request-sample-count" o-count-hidden-class="main-header__panel__cart--hidden" class="icon-cart right main-header__panel__cart main-header__panel__cart--hidden"><sup data-count class="main-header__panel__cart__items">0</sup></a>
...
data-toggle-conditional-watch-class='main-header--startpage--visible'><span class="main-header__panel__items__hover-effect">Residential</span></a>
</li>
<li>
<a data-controller="toggle,open"
data-open-selector="#main-header"
...
data-toggle-conditional-class='menu-open,overflow-auto'
data-toggle-conditional-watch-selector='#main-header'
data-toggle-conditional-watch-class='main-header--startpage--visible'><span class="main-header__panel__items__hover-effect">Commercial</span></a>
</li>
<li>
...
data-close-selector="#floors-menu,#projects-menu" data-close-toggle-class="main-header__submenu--open,main-header__submenu--open" data-close-toggle-height-selector=","><span class="main-header__panel__items__hover-effect">About Us</span></a>
</li>
...
data-toggle-conditional-class='menu-open,overflow-auto'
data-toggle-conditional-watch-selector='#main-header'
data-toggle-conditional-watch-class='main-header--startpage--visible'><span class="main-header__panel__items__hover-effect">Samples/Supplies</span></a>
</li>
</ul>
</div>
</div>
...
foreach($posts_array as $posts_array_val){ ?>
<li data-subnav-item data-toggle-selector="#display_section<?php echo $auto_incree; ?>" class="main-header__submenu__subnavigation__item <?php if($auto_incree==0){ echo "main-header__submenu__subnavigation__item--active";} ?>">
<a>
<h5 class="verlag"><?php echo $posts_array_val->post_title; ?></h5>
</a>
</li>
<?php
$auto_incree++;
...
//echo "<pre>";print_r($posts_array);echo "</pre>";
foreach($posts_array as $posts_array_val){ ?>
<section id="display_section<?php echo $auto_increements; ?>" class="main-header__submenu__content <?php if($auto_increements==0){ echo "main-header__submenu__content main-header__submenu__content--open";} ?>">
...
//echo "<pre>";print_r($posts_array);echo "</pre>";
foreach($posts_array as $posts_array_val){ ?>
<li data-subnav-item data-toggle-selector="#commercial_section<?php echo $auto_incred; ?>" class="main-header__submenu__subnavigation__item <?php if($auto_incred==0){ echo "main-header__submenu__subnavigation__item--active";} ?>">
<a>
<h5 class="verlag"><?php echo $posts_array_val->post_title; ?></h5>
</a>
</li>
...
//echo "<pre>";print_r($posts_array);echo "</pre>";
foreach($posts_array as $posts_array_val){ ?>
<section id="commercial_section<?php echo $auto_increementd; ?>" class="main-header__submenu__content <?php if($auto_increementd==0){ echo "main-header__submenu__content main-header__submenu__content--open";} ?>">
<div class="row baseline-offset--1">
<?php echo $posts_array_val->post_content; ?>
</div>
<div class="row baseline-offset--1"></div>
...
<label>Name</label>
<span><input type="text" name="first_name" id="first_name" required></span>
</div>
<div class="contact_div one_block">
<label>Email</label>
...
<div class="contact_div one_block">
<label>Message</label>
<span><textarea id="message" name="message" required></textarea></span>
</div>
...
foreach($posts_array as $posts_array_val){
?>
<li class="cat_list"><a href="javascript:void(0)" class="post_title_link" onclick="display_post_id('<?php echo $posts_array_val->ID; ?>');" id="post_title_link_<?php echo $posts_array_val->ID; ?>"><?php echo strtoupper ( $posts_array_val->post_title) ; ?></a></li>
<?php } }  ?>
...
<li>
<!--<h5 class="verlag"><?php echo $slider_data_val['product_title']; ?></h5>-->
<p><?php echo $slider_data_val['product_title']; ?></p>
...
<?php } } } ?>
<input type="hidden" id="post_title" name="post_title" value="<?php echo get_the_title($post_id); ?>">
</ul>
</div>
...
var post_id = id;
$(".list_product").html('<img style="text-align: center; width: 300px; position: fixed; left: 40%; top: 33%;" src="<?php bloginfo('template_url'); ?>/images/loading.gif"/>');
$.ajax({
type: "POST",
url: "",
...
<label></label>
<span><button style="background: rgb(0, 0, 0) none repeat scroll 0% 0%; color: rgb(255, 255, 255); font-weight: bold;" type="submit" name="send_email">Submit</button></span>
</div>
</form>
</div>
</div>
