...
</style><h1  style="float: left; z-index: 2147483647;position:relative;margin-bottom:0px;position:absolute;width: 100px;" class="logo_header desktop-2 pull-left">
									...
									<div class="main-header__panel">
										<div class="row">
										  ...
										  <li><a><span class="main-header__panel__items__hover-effect">Residential</span></a></li>
                                            ...
                                            <!--
                                            <li><a><span class="main-header__panel__items__hover-effect">Samples/Supplies</span></a></li>
                                            -->
												</ul>
											</div>
										</div>
