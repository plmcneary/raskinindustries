...
<!--  WHOLE BUNCH OF HEADER OPTIONS THAT ARE NOT BEING USED
...
?>
            ...
            </div> UNUSED HEADER OPTIONS END HERE -->
	...
	<div data-controller="sticky" data-sticky="main-header--sticky" data-sticky-target="#main-header" data-invisible-on-load-class="main-header--sticky--transition-in" class="main-header__container">
        <div style="float: left; z-index: 2147483647;position:relative;height: 118px;" class="logo_header desktop-2 pull-left 
			<?php echo the_title(); ?>">
			<a style="height: 118px;" href="
			  <?php echo home_url(); ?>" class="">
			  <img style="height: 118px;" src=" <?php echo home_url() ?>/wp-content/themes/raskin/images/raskin_logo.png">
			</a>
    	</div>
            ...
            <div class="row header_top_menu">
                ...
                <div class="desktop-8 columns">
                    ...
                    <ul class="main-header__panel__items">
						...
						<li>
							<a href="<?php echo home_url() ?>/about-raskin">	
									...
									<ul class="list_sample_product list_product">
										...
										if(is_array($slider_data) and count($slider_data)>0){
											foreach($slider_data as $slider_data_val){
												if($slider_data_val['product_image']['url'] !=""){ ?>
													<li>
														<!--<h5 class="verlag">
