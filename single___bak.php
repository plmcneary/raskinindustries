...
margin-top: 4%;
	...
	<a target="_blank"><img src="<?php bloginfo('template_url'); ?>/images/raskin_logo_halfsize.jpg" data-large="<?php echo $slider_data_val['large_image']['url'];  ?>" alt="image01"  style="width:400px;height:400px;" data-description="Raskin" /></a>
	<br> 
	<?php } ?>
...
<!--		<a href="<?php echo get_site_url(); ?>/design-a-room?id=<?php echo get_the_id(); ?>&view=<?php echo $auto;  ?>" class="design_page">Design A Room</a>	
	...
	<a href="#"><img src="<?php echo $slider_data_val['product_image']['url'];  ?>" data-large="<?php echo $slider_data_val['product_image']['url'];  ?>" style="width:100%;height:100%;" alt="image01" data-description="Raskin" /></a>
	</li>
	<?php 
	$auto++;
	} } ?>
